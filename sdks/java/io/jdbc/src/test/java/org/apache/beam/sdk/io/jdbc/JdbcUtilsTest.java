    ...
    public void testToBeamSchema() throws SQLException {
        ...
        Schema wantBeamSchema =
                Schema.builder()
                        ...
                        .addField("date_col", JdbcUtils.FIELD_TYPE_DATETIME)
                        ...
                        .addField("timestamptz_col", JdbcUtils.FIELD_TYPE_TIMESTAMP)
        ...
        Schema haveBeamSchema = JdbcUtils.fromResultSetMetaDataToSchema(mockResultSetMetaData);
...
//
//        SchemaUtil.BeamRowMapper beamRowMapper = JdbcIO.BeamSchemaRowMapper.of(wantSchema);
...
//        when(mockResultSet.getTimestamp(eq(2))).thenReturn(new Timestamp(epochMilli));
...
//        Row wantRow =
//                Row.withSchema(wantSchema)
//                        .addValues(wantDateTime.withTimeAtStartOfDay(), wantDateTime, wantDateTime)
//                        .build();
//
//        SchemaUtil.BeamRowMapper beamRowMapper = SchemaUtil.BeamRowMapper.of(wantSchema);
//        Row haveRow = beamRowMapper.mapRow(mockResultSet);
