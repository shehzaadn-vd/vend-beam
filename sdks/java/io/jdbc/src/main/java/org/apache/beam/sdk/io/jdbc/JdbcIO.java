  ...
  public static class Write<T> extends PTransform<PCollection<T>, PDone> {
    ...
    public PDone expand(PCollection<T> input) {
      ...
      if (input.hasSchema() && !hasStatementAndSetter()) {
        ...
        inner = inner.withPreparedStatementSetter(new AutoGeneratedPreparedStatementSetter(schema, fields, input.getToRowFunction()));
      }
    ...
    private static void mapAccordingToSchema(Row element, PreparedStatement preparedStatement, Schema schema, List<Schema.Field> fields) {
//      List<Schema.Field> fields = schema.getFields();
    ...
    private class AutoGeneratedPreparedStatementSetter implements PreparedStatementSetter<T> {
      ...
      AutoGeneratedPreparedStatementSetter(Schema schema, List<Schema.Field> fields, SerializableFunction<T, Row> toRowFn) {
        this.fields = fields;
      ...
      public void setParameters(T element, PreparedStatement preparedStatement) throws Exception {
          ...
          mapAccordingToSchema(row, preparedStatement, schema, fields);
      }
